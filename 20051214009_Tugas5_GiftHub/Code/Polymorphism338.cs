...
namespace Polymorphism338
{
    class Polymorphis338

    {
        ...
        {
            var gajiKaryawan = new GajiKaryawan(" Yonathan", " Setiagita", "123-45-6728", 800.00M);
            var karyawanPerJam = new KaryawanPerJam(" Regita", " Christy", "212-43-4122", 16.75M, 40.0M);
            var komisiKaryawan = new KomisiKaryawan("Lisa", "Magn", "321-54-8765", 10000.00M, .06M);
            var gajiPokokPlusKomisiKaryawan = new GajiPokokPlusKomisiKaryawan("Dimas", "Kang", "431-42-9584", 5000.00M, .04M, 300.00M);
