...
namespace InheritanceHal305
{
    class Program
    {
        public class KomisiKaryawan : object
        {
            ...
            {
                KomisiKaryawan karyawan = new KomisiKaryawan("Yonathan", "Setiagita", "123-45-678", 10000.00M, .06M);
                ...
                Console.WriteLine("{0} :  {1}", "Informasi terbaru karyawan yanf diperoleh", karyawan);
